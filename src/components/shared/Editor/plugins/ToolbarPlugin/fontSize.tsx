  ...
  return (
    <div className='flex flex-row'>
      <button
        ...
        className='btn btn-square btn-sm rounded-e-none btn-outline'
      >
        <FaMinus className='' />
      </button>
      ...
      <input
        ...
        value={inputValue}
        disabled={disabled}
        className={`input-sm border-y-[1px] border-base-content rounded-none text-align w-[40px] `}
      ...
      <button
        ...
        className='btn btn-outline btn-square btn-sm rounded-s-none'
      >
        <FaPlus className='' />
      </button>
    </div>
